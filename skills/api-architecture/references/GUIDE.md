...
This guide provides comprehensive documentation for the **api-architecture** skill in the custom-plugin-api-design plugin.
...
```bash
# Invoke the skill
claude "api-architecture - [your task description]"

# Example
claude "api-architecture - analyze the current implementation"
```
...
def implement_api_architecture(input_data):
    """
    Implement api-architecture functionality.
