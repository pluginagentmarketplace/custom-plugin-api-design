...
This guide provides comprehensive documentation for the **security-patterns** skill in the custom-plugin-api-design plugin.
...
```bash
# Invoke the skill
claude "security-patterns - [your task description]"

# Example
claude "security-patterns - analyze the current implementation"
```
...
def implement_security_patterns(input_data):
    """
    Implement security-patterns functionality.
