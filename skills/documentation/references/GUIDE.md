...
This guide provides comprehensive documentation for the **documentation** skill in the custom-plugin-api-design plugin.
...
```bash
# Invoke the skill
claude "documentation - [your task description]"

# Example
claude "documentation - analyze the current implementation"
```
...
def implement_documentation(input_data):
    """
    Implement documentation functionality.
