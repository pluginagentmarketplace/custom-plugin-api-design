...
This guide provides comprehensive documentation for the **frontend-patterns** skill in the custom-plugin-api-design plugin.
...
```bash
# Invoke the skill
claude "frontend-patterns - [your task description]"

# Example
claude "frontend-patterns - analyze the current implementation"
```
...
def implement_frontend_patterns(input_data):
    """
    Implement frontend-patterns functionality.
