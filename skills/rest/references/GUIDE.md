...
This guide provides comprehensive documentation for the **rest** skill in the custom-plugin-api-design plugin.
...
```bash
# Invoke the skill
claude "rest - [your task description]"

# Example
claude "rest - analyze the current implementation"
```
