...
This guide provides comprehensive documentation for the **database-patterns** skill in the custom-plugin-api-design plugin.
...
```bash
# Invoke the skill
claude "database-patterns - [your task description]"

# Example
claude "database-patterns - analyze the current implementation"
```
...
def implement_database_patterns(input_data):
    """
    Implement database-patterns functionality.
