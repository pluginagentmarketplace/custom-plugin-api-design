...
This guide provides comprehensive documentation for the **backend-patterns** skill in the custom-plugin-api-design plugin.
...
```bash
# Invoke the skill
claude "backend-patterns - [your task description]"

# Example
claude "backend-patterns - analyze the current implementation"
```
...
def implement_backend_patterns(input_data):
    """
    Implement backend-patterns functionality.
