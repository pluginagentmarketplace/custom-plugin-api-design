...
This guide provides comprehensive documentation for the **versioning** skill in the custom-plugin-api-design plugin.
...
```bash
# Invoke the skill
claude "versioning - [your task description]"

# Example
claude "versioning - analyze the current implementation"
```
...
def implement_versioning(input_data):
    """
